package com.cg.healthservicemanagementsystem.controller;
...
import com.cg.healthservicemanagementsystem.exception.DietNotFoundException;
import com.cg.healthservicemanagementsystem.service.IDietService;
...
if(dt==null) {
	...
	return new ResponseEntity<Diet>(dt, HttpStatus.OK);
     ...
     //updateDiet
       @PutMapping("/diet/{id}")
    public ResponseEntity<Diet> updateDiet(@PathVariable("id")int id,@RequestBody Diet diet) throws DietNotFoundException {
    ...
    public ResponseEntity<Diet> updateDietType(@PathVariable("id")int id,@RequestBody Diet diet) throws DietNotFoundException{
